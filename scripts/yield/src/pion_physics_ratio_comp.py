...
legend.Draw()
c1_kin.cd(3)
W_pions_simc_cut_all.GetXaxis().SetRangeUser(2.7, 3.2)
...
W_pions_normdummysub_data_cut_all.GetXaxis().SetRangeUser(2.7, 3.2)
...
c2_kin.Divide(2,2)
c2_kin.cd(1)
Q2_pions_simc_cut_all.GetXaxis().SetRangeUser(4.0, 6.0)
...
Q2_pions_normdummysub_data_cut_all.GetXaxis().SetRangeUser(4.0, 6.0)
